                      ...
                      child: Column( mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
                          ...
                          Row(children: <Widget>[
                            ...
                            SizedBox(width: 85,), Text('SignUp Now',style: TextStyle(
                          ...
                          Row(children: <Widget>[
                            ...
                            SizedBox(width: 85,), Text('With TryDan Go!',style: TextStyle(
                                color: Colors.white70,
                                fontWeight: FontWeight.w400,
                                fontSize: 25
                    ...
                    child: Column(children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          SizedBox(width: 20,),
                          Text("Enter Your Details Correctly",style: TextStyle(
